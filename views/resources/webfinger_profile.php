...
<XRD xmlns="http://docs.oasis-open.org/ns/xri/xrd-1.0">
    ...
    <Alias><?= $GLOBALS['ABSOLUTE_URI_STUDIP'].URLHelper::getLink("about.php", array('username' => $user['username'])) ?></Alias>
    <Link rel="http://webfinger.net/rel/profile-page" type="text/html" href="http://identi.ca/krassmus"></Link>
    ...
    <Link rel="http://apinamespace.org/twitter" href="https://identi.ca/api/">
        <Property type="http://apinamespace.org/twitter/username"><?= htmlReady($user['username']) ?></Property>
    </Link>
    ...
    <Link rel="salmon" href="http://identi.ca/main/salmon/user/1046034"></Link>
    <Link rel="http://salmon-protocol.org/ns/salmon-replies" href="http://identi.ca/main/salmon/user/1046034"></Link>
    <Link rel="http://salmon-protocol.org/ns/salmon-mention" href="http://identi.ca/main/salmon/user/1046034"></Link>
